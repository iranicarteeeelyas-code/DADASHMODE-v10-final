...
const SHOT_BY_GAME={
 ...
 sandwich:[['R3-1','واید مستر · شمارش','S1 · 1x · دو بشقاب زیر کاور، دست‌ها پشت کمر'],['R3-2','اسپلیت صورت‌ها','دو کراپ 2x با دو تایمر اپ'],['R3-3','اینسرت اپ','کاشی زرد «موقت» و نوار ۳۰ ثانیهٔ قورت'],['R3-4','بالا · آخرین لقمه','S5 TOP · بشقاب خالی، مدرک خرده‌ها'],['R3-5','دهان خالی · اسلوموشن','T-CAM + S8 · 2x · ۵۰٪'],['R3-6','دونفره + بانک','+۱۵ به کاشی سبز']],
...
const KITS={
 ...
 sandwich:[['ساندویچ یکسان (۲ اصلی + ۲ یدک)',4,false],['ترازوی آشپزخانه',1,false],['بشقاب سفید',2,false],['لیوان آب ۲۰۰ میلی‌لیتری',2,false],['کاور کاغذی',2,false],['دستمال و سطل خارج قاب',1,false],['ناظر ایمنی (هایملیچ) · اورژانس ۱۱۵',1,false]],
...
const KEYWORDS=[[/لیوان/,'لیوان یک‌بار مصرف (هم‌اندازه)'],[/توپ/,'توپ کوچک'],[/سبد|سطل|حلقه/,'سبد / سطل هدف'],[/دستکش/,'دستکش فر (جفت)'],[/پازل|قطعه/,'پازل ۴ تکهٔ آرم گرگ'],[/کیف/,'کیف طلایی'],[/قفل|رمز/,'قفل رمزدار ۳ رقمی'],
 [/چشم[\s‌]*(بسته|بند)/,'چشم‌بند'],[/نقاشی|بکش/,'کاغذ A3 و ماژیک'],[/ساندویچ/,'ساندویچ یکسان (۲ اصلی + ۲ یدک)'],[/بطری/,'بطری'],[/تاس/,'تاس'],[/سوت/,'سوت داور'],[/کرنومتر/,'کرنومتر پشتیبان'],[/معما|منطق/,'برگهٔ معمای منطقی در پاکت'],[/میز/,'میز صاف و بی‌لرزش'],[/چسب/,'چسب پهن'],[/کارت/,'کارت‌های چاپی'],[/خط\s*(سبز|زرد|قرمز)/,'نوار چسب سبز، زرد، قرمز برای خط‌ها'],[/خط\s*پایان/,'نوار خط پایان']];
